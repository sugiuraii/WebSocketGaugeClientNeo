...
$inkscape_cmd --export-type="png" $svg_filename --export-id=layer_shaft --export-id-only

$inkscape_cmd --export-type="png" $svg_filename --export-id=layer_redzone_bar --export-id-only
$inkscape_cmd --export-type="png" $svg_filename --export-id=layer_yellowzone_bar --export-id-only
$inkscape_cmd --export-type="png" $svg_filename --export-id=layer_greenzone_bar --export-id-only
